...
declare module "dbme/w/lib/core/util/Url" {
	import * as UrlUtils from "dbme/c/UrlUtils";
	...
	type TUrlUtils = typeof UrlUtils;

	export type Url = TUrlUtils & {
		Url: typeof DBMEComponentUrl;
		...
		navToWorkshopPlanner(oArgs: TWorkshopPlannerOrder, aApps: TAppEntity[]): void;
		navToTodoBasketDetails(sOrderNumber: string, aApps: TAppEntity[]): void;

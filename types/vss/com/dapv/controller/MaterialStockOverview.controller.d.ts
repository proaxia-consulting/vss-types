...
export default class MaterialStockOverview extends Controller {
    ...
    onRequestFinish(oModel: OData4Model, bAvailabilityCheck: boolean): void;
    getMaterialOverview(oModel: OData4Model, bAvailabilityCheck: boolean, bInitialRequest?: boolean): void;
    getDefaultModel(): OData4Model;
    getDefaultRequestModel(): OData4Model;
    onMaterialOverviewActionFinish(oModel: OData4Model, bAvailabilityCheck: boolean): void;
}

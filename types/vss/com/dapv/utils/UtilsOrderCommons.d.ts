...
import { AvailabilityBarStatus } from "vss/com/dapv/entities/Types";
...
export declare function getSwapATPState(bAvailabilityStatus: boolean, oATPOverview: MaterialATPOverview, oMapKey: MessageType | undefined, oSwapReservationsMemo: SwapATPReservations | undefined): ValueState;
export declare function getSwapATPStatus(bAvailabilityStatus: boolean, oATPOverview: MaterialATPOverview, oMapKey: MessageType | undefined, oSwapReservationsMemo: SwapATPReservations | undefined): string;
export declare function getSwapATPTooltip(bAvailabilityStatus: boolean, oATPOverview: MaterialATPOverview, oMapKey: MessageType | undefined, oSwapReservationsMemo: SwapATPReservations | undefined): string;

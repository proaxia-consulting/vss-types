...
import OrderController from "vss/com/dama/controller/Order.controller";
/**
 * @namespace vss.com.dama.eh.header
 */
export declare function onMileageUpdate(this: OrderController, event: Event): void;
export declare function onTestDriveChanged(this: OrderController, event: Event): void;
...
export declare function onOrderIdPress(this: OrderController, event: Event): void;
...
export declare function onLinkListItem(this: OrderController, event: Event): void;
export declare function onMultipleJobApproval(this: OrderController, event: Event): void;
export declare function onHeaderDescriptionLinkPress(this: OrderController, event: Event): void;

...
export default class Index extends AbstractController {
    ...
    helper: {
        list: {
            onBindingChange(this: Index, event: import("ui5").$EventTyped<{
                reason: string;
        ...
        smartFilter: {
            applyFiltersFromData(this: Index, data: Record<string, number | string | string[]>, replace?: boolean): Promise<void>;
            applyFilters(this: Index, ...filter: import("sap/ui/model/Filter").default[]): Promise<void>;
            onSearch(this: Index, event: import("ui5").$EventTyped<{}, SmartFilterBar>): void;
            onClear(this: Index, event: import("ui5").$EventTyped<{}, SmartFilterBar>): void;
        };
    };
    onInit(): void;

...
import type { SmartTable$BeforeRebindTableEvent, default as SmartTable } from "sap/ui/comp/smarttable/SmartTable";
...
export default class Create extends AbstractOrder {
    ...
    onBeforeRebindSearchResults(event: SmartTable$BeforeRebindTableEvent): void;

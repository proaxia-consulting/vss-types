...
import type { IDemandsAwareController, ISelectableControl } from "dbme/srs/com/tdo/types/IController";
...
declare const DecisionTreeTemplate: {
    ...
    onDecissionTreeSelectionChange(this: IDemandsAwareController, oEvent: Event<{
        selected?: boolean;
    }, ISelectableControl>): void;

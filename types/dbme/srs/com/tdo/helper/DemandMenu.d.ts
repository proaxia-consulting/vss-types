...
declare const DemandMenu: {
    show(this: IDemandsAwareController, event: Button$PressEvent): Promise<Menu>;
    onMenuItemSelect(this: IDemandsAwareController, event: MenuItemBase$SelectEvent): void;
};
/**

declare module "src/vss/com/rcl/model/Enums" {
...
declare module "src/vss/com/rcl/types/EntitySet" {
    ...
    import type { AttachmentModelFunction, CharacteristicDataTypeType, DocumentIOTypeType, FieldDataTypeType, RentalClassTypeType } from "src/vss/com/rcl/model/Enums";
...
declare module "src/vss/com/rcl/model/format/CharacteristicValues" {
    import { TObjectCharacteristicsDisplay } from "src/vss/com/rcl/types/EntitySet";
...
declare module "src/vss/com/rcl/cart/ICartModel" {
    ...
    import type { RentalClassTypeType } from "src/vss/com/rcl/model/Enums";
...
declare module "src/vss/com/rcl/cart/CartItemKey" {
    import type { TCartItem } from "src/vss/com/rcl/cart/ICartModel";
    /**
     * @name vss.com.rcl.cart.CartItemKey
     */
    export default function CartItemKey(item: TCartItem): string;
}
declare module "src/vss/com/rcl/model/RootEntity" {
    import type { TRootEntity, TRootObjectKey } from "src/vss/com/rcl/types/EntitySet";
    export function isEquipment(entity: TRootEntity): boolean;
    export function createKey(entity: TRootEntity): TRootObjectKey;
}
declare module "src/vss/com/rcl/cart/CartItemFactory" {
    import type { TCartItem, TContractItemNumber } from "src/vss/com/rcl/cart/ICartModel";
    import type { TRootEntity } from "src/vss/com/rcl/types/EntitySet";
...
declare module "src/vss/com/rcl/cart/ICart" {
    ...
    import type { TCartItem, ICartModel, TCartHeader } from "src/vss/com/rcl/cart/ICartModel";
    interface ICart {
...
declare module "src/vss/com/rcl/utils/Container" {
    ...
    import type ICart from "src/vss/com/rcl/cart/ICart";
...
declare module "src/vss/com/rcl/cc/model/CartItemsToContract" {
...
declare module "src/vss/com/rcl/cc/eh/ContractDraftCreateHandler" {
...
declare module "src/vss/com/rcl/utils/ContractNavigation" {
...
declare module "src/vss/com/rcl/clfn/ClfnFilterFieldFactory" {
    import Label from "sap/m/Label";
    import type { TCharcEntity } from "src/vss/com/rcl/types/EntitySet";
...
declare module "src/vss/com/rcl/component/AppComponentAbstract" {
    import AppComponent from "sap/fe/core/AppComponent";
    /**
...
declare module "src/vss/com/rcl/component/UIComponentAbstract" {
...
declare module "src/vss/com/rcl/control/IsControl" {
...
declare module "src/vss/com/rcl/types/IComponent" {
    import type AppComponent from "sap/fe/core/AppComponent";
...
declare module "src/vss/com/rcl/eqs/types/EntitySets" {
...
declare module "src/vss/com/rcl/eqs/model/EquipmentBindingUtil" {
    import type { TEquipmentKey } from "src/vss/com/rcl/eqs/types/EntitySets";
    export function createBindingPath(entity: TEquipmentKey): string;
}
declare module "src/vss/com/rcl/types/IController" {
...
declare module "src/vss/com/rcl/eqs/model/Enums" {
...
declare module "src/vss/com/rcl/eqs/model/RouteTarget" {
    import { RouteTarget } from "src/vss/com/rcl/eqs/model/Enums";
    export default RouteTarget;
}
declare module "src/vss/com/rcl/eqs/Component" {
    import AppComponentAbstract from "src/vss/com/rcl/component/AppComponentAbstract";
    import type NavContainer from "sap/m/NavContainer";
    import type Model from "sap/ui/model/Model";
    import type ODataModel from "sap/ui/model/odata/v4/ODataModel";
    import type { $IEquipmentAwareComponentSettings, IEquipmentAwareComponent } from "src/vss/com/rcl/types/IComponent";
    import type { InvokablePageController } from "src/vss/com/rcl/types/IController";
    /**
...
declare module "src/vss/com/rcl/model/EquipmentHierarchyQuery" {
    import type ODataModel from "sap/ui/model/odata/v4/ODataModel";
    import type { TEquipmentHierarchyCustomEntity, TRootObjectKey } from "src/vss/com/rcl/types/EntitySet";
...
declare module "src/vss/com/rcl/eqs/model/EventId" {
    import { EventId } from "src/vss/com/rcl/eqs/model/Enums";
    /**
     * Provide default export for EventId due duplicated import names in Component.ts
     */
    export default EventId;
}
declare module "src/vss/com/rcl/eqs/controller/Tree.controller" {
    ...
    import type AppComponent from "src/vss/com/rcl/eqs/Component";
    import type { InvokablePageController } from "src/vss/com/rcl/types/IController";
...
declare module "src/vss/com/rcl/eqs/i18n/Translate" {
    import type ResourceBundle from "sap/base/i18n/ResourceBundle";
    export function setBundle(b: ResourceBundle): void;
    export function __(key: string, args?: unknown[]): string;
    const Translate: typeof __;
...
declare module "src/vss/com/rcl/eqs/model/ControlId" {
    import { ControlId } from "src/vss/com/rcl/eqs/model/Enums";
    /**
     * Provide default export for ControlId due duplicated import names in Component.ts
     */
    export default ControlId;
}
declare module "src/vss/com/rcl/eqs/types/EventParams" {
    import type PageController from "sap/fe/core/PageController";
    import type { ListBase$UpdateFinishedEvent } from "sap/m/ListBase";
...
declare module "src/vss/com/rcl/eqscol/Enums" {
    export const FieldGroupId: {
        readonly ColumnEquipmentStructure: "ColumnEquipmentStructure";
    };
}
declare module "src/vss/com/rcl/eqsui/Component" {
    import type Event from "sap/ui/base/Event";
    import ComponentContainer from "sap/ui/core/ComponentContainer";
    import UIComponentAbstract from "src/vss/com/rcl/component/UIComponentAbstract";
    import type ODataModel from "sap/ui/model/odata/v4/ODataModel";
    import type { $IEquipmentAwareComponentSettings, EquipmentStructureSettings } from "src/vss/com/rcl/types/IComponent";
...
declare module "src/vss/com/rcl/eqsui/i18n/Translate" {
    import type ResourceBundle from "sap/base/i18n/ResourceBundle";
    export function setBundle(b: ResourceBundle): void;
    export function __(key: string, args?: unknown[]): string;
    const Translate: typeof __;
...
declare module "src/vss/com/rcl/ml/i18n/Translate" {
    import type ResourceBundle from "sap/base/i18n/ResourceBundle";
    export function setBundle(b: ResourceBundle): void;
    export function __(key: string, args?: unknown[]): string;
    const Translate: typeof __;
...
declare module "src/vss/com/rcl/ml/model/EventId" {
    import { EventId } from "src/vss/com/rcl/ml/model/Enums";
    /**
     * Provide default export for EventId due duplicated import names in Component.ts
     */
    export default EventId;
...
declare module "src/vss/com/rcl/utils/EventBusHandlers" {
...
declare module "src/vss/com/rcl/model/RootEntityQuery" {
    import type { TRootEntity } from "src/vss/com/rcl/types/EntitySet";
    import type ODataModel from "sap/ui/model/odata/v4/ODataModel";
...
declare module "src/vss/com/rcl/ml/ext/ActionColumnExtension" {
...
declare module "src/vss/com/rcl/ml/eh/EquipmentStructureComponent" {
    import { $EquipmentStructureTreeEvent } from "src/vss/com/rcl/eqs/types/EventParams";
...
declare module "src/vss/com/rcl/ml/model/EquipmentHierarchyColumnQuery" {
    import type ODataModel from "sap/ui/model/odata/v4/ODataModel";
    import type { TEquipmentHierarchyCustomEntity } from "src/vss/com/rcl/types/EntitySet";
    import type Context from "sap/ui/model/odata/v4/Context";
    /**
...
declare module "src/vss/com/rcl/ml/ext/ColumnEquipmentStructure" {
    import type { IListReportExtensionAPI } from "vss/com/fe/ListReport";
...
declare module "src/vss/com/rcl/templates/ObjectPage/AbstractObjectPageExtension" {
...
declare module "src/vss/com/rcl/ml/ext/ObjectPageToolbarExtension" {
    import AbstractObjectPageExtension from "src/vss/com/rcl/templates/ObjectPage/AbstractObjectPageExtension";
    import type { TRootEntity } from "src/vss/com/rcl/types/EntitySet";
    /**
     * @nonui5
     * @namespace vss.com.rcl.ml.ext
...
declare module "src/vss/com/rcl/ml/ext/SectionAccessories" {
    import AbstractObjectPageExtension from "src/vss/com/rcl/templates/ObjectPage/AbstractObjectPageExtension";
    import type { TRootEntity } from "src/vss/com/rcl/types/EntitySet";
    /**
     * @nonui5
...
declare module "src/vss/com/rcl/model/RentalApplicationModelFactory" {
...
declare module "src/vss/com/rcl/ml/ext/controller/MaterialNSObjectPage.controller" {
    import ControllerExtension from "sap/ui/core/mvc/ControllerExtension";
...
declare module "src/vss/com/rcl/ml/ext/controller/RootObjectPage.controller" {
    import ControllerExtension from "sap/ui/core/mvc/ControllerExtension";
...
declare module "src/vss/com/rcl/model/ContextUtils" {
    import type Context from "sap/ui/model/odata/v4/Context";
    import type { IListReportExtensionAPI } from "vss/com/fe/ListReport";
    import type { IObjectPageExtensionAPI } from "vss/com/fe/ObjectPage";
    const ContextUtils: {
...
declare module "src/vss/com/rcl/model/EquipmentHierarchyWithRootQuery" {
    import type { TRootObjectKey } from "src/vss/com/rcl/types/EntitySet";
    import EquipmentHierarchyQuery from "src/vss/com/rcl/model/EquipmentHierarchyQuery";
    /**
     * @nonui5
     * @namespace vss.com.rcl.model
...
declare module "src/vss/com/rcl/model/format/prefix" {
    const prefix: {
...
declare module "src/vss/com/rcl/templates/CharacteristicsDisplayItemFactory" {
    import ObjectStatus from "sap/m/ObjectStatus";
    import type Context from "sap/ui/model/odata/v4/Context";
    export function create(id: string, context: Context): ObjectStatus;
}
declare module "src/vss/com/rcl/templates/TemplateFragment" {
...
declare module "src/vss/com/rcl/templates/ObjectPage/AbstractObjectPageSectionExtension" {
    import type Control from "sap/ui/core/Control";
    import AbstractObjectPageExtension from "src/vss/com/rcl/templates/ObjectPage/AbstractObjectPageExtension";
    export interface IContentAware extends Control {
        getContent(): Control;
...
declare module "src/vss/com/rcl/templates/ObjectPage/SectionEquipmentHierarchy" {
    import type { IEquipmentHierarchyQuery } from "src/vss/com/rcl/model/EquipmentHierarchyQuery";
